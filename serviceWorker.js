...
var urlsToCache = [
  ...
  '/main.css',
  '/assets/js/main.js',
  '/images/shoppingBoavista.png',
  '/images/shoppingBoavistaP.png',
  '/images/shoppingRecife.png',
  '/images/shoppingRecifeP.png',
  '/images/shoppingRiomar.png',
  '/images/shoppingRiomarP.png',
  '/images/shoppingTacaruna.png',
  '/images/shoppingTacarunaP.png',
  '/images/vacinaFoto.png',
  '/shoppingBoavista.html',
  '/shoppingRecife.html',
  '/shoppingRiomar.html',
  '/shoppingTacaruna.html'
  ]
